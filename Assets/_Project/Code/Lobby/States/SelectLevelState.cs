...
namespace _Project.Code.Lobby.States
{
    public class SelectLevelState : IState
    {
        ...
        public SelectLevelState(ConfigProvider configProvider
            , SelectLevelStateView stateView)
        {
            _config = configProvider.GetSingleImmediately<LobbyCameraRotation>(AssetPath.Config.SelectLevelCameraRotation);
